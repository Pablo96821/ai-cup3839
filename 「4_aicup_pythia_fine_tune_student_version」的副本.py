...
Original file is located at
    https://colab.research.google.com/drive/1Eq7WitSSllc_uGTaoS2-kn7p5PGMJYmZ
"""
...
PHI=frozenset({"PATIENT","DOCTOR","UESRNAME","PROFESSION","ROOM","DEPARTMENT",
               "HOSPITAL","ORGANIZATION","STREET","CITY","STATE","COUNTRY","ZIP",
               "LOCATION-OTHER","AGE","DATE","TIME","DURATION","SET","PHONE","FAX",
               "EMAIL","URL","IPADDR","SSN","MEDICALRECORD","HEALTHPLAN","ACCOUNT",'LICENSE',
               "VECHICLE","BIOID","IDNUM","OTHER"})
...
ipdata.to_csv("test.txt", sep='\t', index=False, header=False)